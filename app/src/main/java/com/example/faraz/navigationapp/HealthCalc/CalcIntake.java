...
public class CalcIntake extends AppCompatActivity implements View.OnClickListener, TextWatcher {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calc_intake);
            ...
            (new AlertDialog.Builder(this))
                    .setItems(R.array.activities_entries, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (met > 0) {
                                final EditText fld_duration = new EditText(CalcIntake.this);
                                fld_duration.setInputType(InputType.TYPE_CLASS_NUMBER);
                                (new AlertDialog.Builder(CalcIntake.this))
